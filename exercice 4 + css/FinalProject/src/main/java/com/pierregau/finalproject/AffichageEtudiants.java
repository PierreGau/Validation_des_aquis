...
public class AffichageEtudiants extends HttpServlet
{
            ...
            throws ServletException, IOException 
    {
        ...
        listeEtudiant.add(new Etudiant("1","Etudiant1", 15,"images/img1.jpg"));
        listeEtudiant.add(new Etudiant("2","Etudiant2", 7,"images/img2.jpg"));
        listeEtudiant.add(new Etudiant("3","Etudiant3", 11,"images/img3.jpg"));
        listeEtudiant.add(new Etudiant("4","Etudiant4", 13,"images/img4.jpg"));
        listeEtudiant.add(new Etudiant("5","Etudiant5", 9,"images/img5.jpg"));
